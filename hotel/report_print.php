...
//FORMAT DATE
  ...
  <tr>
	...
	<td>RM <?php echo number_format($info1['payment'],2); ?></td>
	<td>RM <?php echo number_format($info1['payment']*$totaldays,2);
	$totalAmount+=($info1['payment']*$totaldays);
  ?></td>
    </tr>
  <?php $no++; } ?>
     <tr>
 ...
 <hr /><div align="center" class="style15">*Report End *<br />Total Rec-
ords:<?php echo $total_rec; ?></div>
 <center><br><br>
 ...
 <body><FONT SIZE="+3" COLOR="RED" font face="Comic sans MS"><i>
  <marquee> THANK YOU !!! COME AGAIN</marquee>
 </body>
</html>