...
$dataBooking=mysqli_query($samb,"SELECT * FROM booking
...
$Out = date("d-m-Y", strtotime($Booking['check_out']));
  ...
  <tr><td><?php echo $no; ?></td>
	...
	$totalAmount+=($Booking['payment']*$totalday);?></td>
  </tr>
  <?php $no++; } ?>
 <tr>
  <td colspan="9" align="right">Total Amount
	</td>
	<td>RM <?php echo number_format($totalAmount,2);?></td>
 </tr>
</table>
<hr /><div align="center" class="style15">* Report End *<br>/>Total Records:<?php echo $no-1; ?></div><center><br><br>
<a href="index2.php"><button>MAIN MENU</button></a><br>
<a href="javascript:window.print()"><button>PRINT</button></a></center></body><br>
